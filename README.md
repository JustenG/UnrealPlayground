# Unreal Playground
A repo to mess around with Unreal Engine, follow tutorials, work through courses and everything in between.

# 08/06/24
Today I start the **[Professional Game Development in C++ and Unreal Engine](https://courses.tomlooman.com/p/unrealengine-cpp?coupon_code=COMMUNITY15&src=github)** by Tom Looman. The following infomation will explain the what to expect upon it's completion
